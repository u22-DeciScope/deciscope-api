...
type MeetingTreeAuditResultClassification string

const (
	MeetingTreeAuditResultClean        MeetingTreeAuditResultClassification = "clean"
	MeetingTreeAuditResultFindingsOnly MeetingTreeAuditResultClassification = "findings_only"
	MeetingTreeAuditResultRejected     MeetingTreeAuditResultClassification = "rejected"
	MeetingTreeAuditResultApplied      MeetingTreeAuditResultClassification = "applied"
)
...
type MeetingTreeAuditRun struct {
	...
	Result                   string
	Disposition              string
	ResultClassification     MeetingTreeAuditResultClassification
	ConsecutiveUnappliedRuns int
